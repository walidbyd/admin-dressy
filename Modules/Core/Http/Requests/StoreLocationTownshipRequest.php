...
class StoreLocationTownshipRequest extends FormRequest
{
    ...
    public function __construct(CoreFieldService $coreFieldFilterSettingService)
    {
    ...
    public function rules()
    {
        ...
        $coreFields = $this->coreFieldFilterSettingService->getAll($conds);

        $validationRules = [
            [
                'fieldName' => 'name',
                'rules' => 'required|min:3|unique:psx_location_townships,name,',
            ],
            [
