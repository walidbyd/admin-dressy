<template>
    ...
    <ps-layout>
        ...
        <!-- alert banner start -->
       <ps-banner-icon v-if="$page.props.status && visible" :visible="visible" :flag="$page.props.status.flag"
            iconColor="white" class="text-white mb-5 sm:mb-6 lg:mb-8">
            {{ $page.props.status.msg }}
        </ps-banner-icon>
        <!-- alert banner end -->
