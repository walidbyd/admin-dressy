...
import PsLangConst from '../../../../../TemplateCore/object/constant/ps_language_const';
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function handleSubmit() {
            ...
            // if not inlucde prefix, add prefix
            if(!form.key.includes(PsLangConst.VENDOR_PREFIT)){
                form.key = PsLangConst.VENDOR_PREFIT + form.key;
            }
