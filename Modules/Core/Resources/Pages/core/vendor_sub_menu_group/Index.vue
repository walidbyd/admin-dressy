           ...
           <!-- alert banner start -->
            ...
            <ps-table2 :row="row" :search="search" :object="sub_menu_groups" :colFilterOptions="colFilterOptions"
                ...
                @handleRow="handleRow" :searchable="showFilter">
                    ...
                    <template #button>
                        <ps-button v-if="can.createVendorSubMenuGroup" @click="handleCreate()" rounded="rounded-lg" type="button" class="flex flex-wrap items-center"> <ps-icon name="plus" class="me-1 font-semibold" />{{$t('add_vendor_sub_menu_group')}}</ps-button>
                    </template>
