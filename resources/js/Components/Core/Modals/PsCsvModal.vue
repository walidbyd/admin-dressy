                ...
                <ps-draggable class=" mt-4 px-2.5" @drop.prevent="drop">
                    ...
                    <ps-label textColor="text-secondary-600 mt-3">{{ $t("ps_csv_modal__follow_setps") }} : <br>
                        <span v-if="isLanguage">
                            {{ $t("ps_csv_modal__language_follow_step_1") }}<br>
                            {{ $t("ps_csv_modal__language_follow_step_2") }}<br>
                            {{ $t("ps_csv_modal__language_follow_step_3") }}
                        </span>
                        <span v-else-if="isCityTownship">
                            {{ $t("ps_csv_modal__city_follow_setp_1") }} <ps-link-1 :url="url" textColor="text-blue-500"> {{ $t('sample_download_here') }} </ps-link-1><br>
                            {{ $t("ps_csv_modal__city_follow_setp_2") }}<br>
                            {{ $t("ps_csv_modal__city_follow_setp_3") }}
                        </span>
                        <span v-else>
